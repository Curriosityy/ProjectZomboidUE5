 ...
 * 
 */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnItemsHolderCountChanged, USearchForPickupColliderComponent*,
                                            itemsCountUpdated);
...
private:
	...
	UFUNCTION()
	void OnStartOverlap(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
